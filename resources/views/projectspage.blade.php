...
================================================== -->
  <body>
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          <img class="img-circle" src="http://localhost/myWebsite/resources/views/hangmanIcon.png" alt="Generic placeholder image" width="140" height="140">
          <h2>Hangman Game</h2>
        ...
        <div class="col-lg-4">
          <img class="img-circle" src="http://localhost/myWebsite/resources/views/jafarsjavaIcon.png" alt="Generic placeholder image" width="140" height="140">
          <h2>Jafar's Java</h2>
        ...
        <div class="col-lg-4">
          <img class="img-circle" src="http://localhost/myWebsite/resources/views/wheretoeatIcon.jpg" alt="Generic placeholder image" width="140" height="140">
      ...
      <div class="row">
        <div class="col-lg-4">
          <img class="img-circle" src="http://localhost/myWebsite/resources/views/emailsystemIcon.png" alt="Generic placeholder image" width="140" height="140">
          <h2>Email System</h2>
        ...
        <div class="col-lg-4">
          <img class="img-circle" src="http://localhost/myWebsite/resources/views/pokergameIcon.jpg" alt="Generic placeholder image" width="140" height="140">
          <h2>Poker Game</h2>
