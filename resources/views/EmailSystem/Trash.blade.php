    ...
    <div class="col-sm-5">
      ...
      <tbody>
        <tr>
          ...
          <td>Why do you keep ignoring me?</td>
          <td>03/23/2017</td>
        </tr>
        <tr class="table">
          <th scope="row">
          ...
          <td>Mom</td>
          <td>Are you deleting my messages?</td>
          <td>03/16/2017</td>
        </tr>
        <tr class="table"> 
          <th scope="row">
          ...
          <td>Grandma</td>
          <td>Hi grandson, My computer is acting up again...</td>
          <td>02/16/2017</td>
        </tr>
        <tr class="table-active"> 
          ...
          <td>Grandma</td>
          <td>I think my computer needs it's fluids topped off. PLEASE HELP</td>
          <td>02/04/2017</td>
        </tr>
        <tr class="table-active"> 
          <th scope="row">
          ...
          <td>Auntie</td>
          <td>My Computer has a blue screen...</td>
          <td>01/02/2017</td>
        </tr>  
        <tr class="table-active"> 
          <th scope="row">
          ...
          <td>Crescenta Valley Highschool</td>
          <td>Highschool reunion RSVP</td>
          <td>01/02/2017</td>
        </tr>         
      </tbody>
      </table>
          ...
          <div class="row"">
           <div class="col-sm-12">
            ...
            <button type="button" class="btn btn-success">Restore all</button>
