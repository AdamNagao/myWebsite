    ...
    <div class="col-sm-5">
      ...
      <tbody>
        <tr>
          ...
          <td>The guy that pays your paychecks</td>
          <td>An important message</td>
          <td>03/25/2017</td>
        </tr>
        <tr class="table">
          <th scope="row">
          ...
          <td>The guy that pays the guy who pays your paychecks</td>
          <td>A slightly more important message</td>
          <td>03/12/2017</td>
        </tr>
        <tr class="table"> 
          <th scope="row">
          ...
          <td>Girl at the Office</td>
          <td>A slightly little more important message than the other messages around it</td>
          <td>02/20/2017</td>
        </tr>
        <tr class="table"> 
          <th scope="row">
          ...
          <td>Client</td>
          <td>I was important, but then I was read</td>
          <td>01/04/2017</td>
        </tr>
      </table>          
          <div class="row"">
           <div class="col-sm-12">
            ...
            <button type="button" class="btn btn-success">Mark as Spam</button>
            <button type="button" class="btn btn-warning">Star Message</button>
          </div>
          </div>
